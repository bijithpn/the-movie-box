...
class _HomeViewState extends State<HomeView>
  ...
  int moviepageCount = 1, tvSeriesPageCount = 1, animePageCount = 1;
  ...
  void initState() {
    ...
    _homeBloc = BlocProvider.of<HomeBloc>(context)..add(GetMovies());
    ...
    _animeScrollController.addListener(() {
      if (_animeScrollController.position.pixels ==
        ...
        animePageCount = animePageCount + 1;
        _homeBloc.add(GetMoreAnimes(pageCount: animePageCount));
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: TabBarView(
        controller: _tabController,
        children: [
          _buildTabContent(_moviesScrollController),
          _buildTabContent(_tvSeriesScrollController),
          _buildTabContent(_animeScrollController),
        ],
      ),
    );
  }

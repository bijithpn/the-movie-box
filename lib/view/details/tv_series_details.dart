...
class _SeriesDetailsViewState extends State<SeriesDetailsView> {
  ...
  void initState() {
    super.initState();
    BlocProvider.of<DetailsBloc>(context).add(GetSeriesDetails(widget.serieId));
  }
            ...
            IconButton(
                ...
                onPressed: () {
                  Utils.deeplinkCreater(
                      route: 'seriesdetails', showId: widget.serieId);
                },
                icon: Container(
                    alignment: Alignment.center,
                    padding: const EdgeInsets.all(10),
                                            ...
                                            Padding(
                                              padding:
                                                  const EdgeInsets.symmetric(
                                                      horizontal: 10),
                                              child: Text(
                                                  "Duration: ${series.episodeRunTime.first} min"),
                                            ),
                                        ],
                                      ),
                                    ],
